...
Optional: add start_time/end_time for timeline slice, include_cpu=true for CPU profiling, good_etl for comparison.`,
  {
    ...
    start_time: z.string().optional().describe("Timeline slice start timestamp. Accepts: microseconds (17677000), milliseconds (84ms), seconds (17.6s), relative (+84ms, +17.6s), or raw xperf timestamps"),
    end_time: z.string().optional().describe("Timeline slice end timestamp. Same formats as start_time"),
